...
### Status: Phase 2 IN PROGRESS — Step 0 DONE (2026-06-15)
...
| 1 | Harvester CRUD (response-modeled) | TODO | | | /api/health, /api/plans*, /api/rungs*, /api/symbols*, /api/dashboard/stats + Pydantic req/resp models matching types.ts; test_api_smoke.py |
