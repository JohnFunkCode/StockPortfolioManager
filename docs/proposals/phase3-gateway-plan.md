...
### Status: Phase 3 IN PROGRESS — Step 8 DONE (api + 5 wrappers live on Cloud Run in the test project; JWT enforced; full wrapper→api→service→Cloud SQL smoke green; 2026-06-17)
