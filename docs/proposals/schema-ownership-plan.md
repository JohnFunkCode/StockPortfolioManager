...
**Status:** PR 4 of 4 in flight — PRs 1–3 merged ([#172](https://github.com/JohnFunkCode/StockPortfolioManager/pull/172), [#173](https://github.com/JohnFunkCode/StockPortfolioManager/pull/173), [#174](https://github.com/JohnFunkCode/StockPortfolioManager/pull/174)) and soaked warn-only on both projects; PR 4 flips `auto` to enforce
